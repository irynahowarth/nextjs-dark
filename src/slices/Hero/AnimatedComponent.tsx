...
import usePreferseReducedMotion from "@/app/hooks/usePrefersReducedMotion"

export default function AnimatedComponent({ slice }: { slice: Content.HeroSlice }) {
  ...
  useGSAP(() => {
    ...
    tl.fromTo(".hero__button", { scale: 1.5 }, { scale: 1, opacity: 1.3},"-=0.8")
    tl.fromTo(".hero__image", { y:100 }, { y: 0, opacity: 1.3},"+=0.3")
  ...
  return (
    ...
    {isFilled.link(slice.primary.button_link) && (
      <ButtonLink className="hero__button mt-8 opacity-0" field={slice.primary.button_link}>{slice.primary.button_label}</ButtonLink>)}
